...
import {ConvolutionDefinition, mobileNetArchitectures} from './lib/mobilenet';

const GOOGLE_CLOUD_STORAGE_DIR =
    'https://storage.googleapis.com/tfjs-models/weights/posenet/';

const LOCAL_DIR = './dist/posenet_weights/posenet_weights/';//__dirname.replace(/\\/g,"/") + '/posenet_weights/posenet_weights/';
...
export const localCheckpoints: {[multiplier: number]: Checkpoint} = {
  1.01: {
    url: LOCAL_DIR + 'mobilenet_v1_101/',
    architecture: mobileNetArchitectures[100]
  },
  1.0: {
    url: LOCAL_DIR + 'mobilenet_v1_100/',
    architecture: mobileNetArchitectures[100]
  },
  0.75: {
    url: LOCAL_DIR + 'mobilenet_v1_075/',
    architecture: mobileNetArchitectures[75]
  },
  0.5: {
    url: LOCAL_DIR + 'mobilenet_v1_050/',
    architecture: mobileNetArchitectures[50]
  }
}
